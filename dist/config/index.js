...
export function loadConfig() {
    ...
    const config = {
        ...
        identity: {
            ...
            persona: (process.env.MERISTEM_IDENTITY_PERSONA ?? fileConfig.identity?.persona ?? 'AGENT'),
        },
        paths: {
        ...
        logging: {
            ...
            format: (process.env.MERISTEM_LOGGING_FORMAT ?? fileConfig.logging?.format ?? 'json'),
        },
    };
